<template>
  <li class="list-group-item list-group-item-action d-flex align-items-center" @click.stop="$emit('change', index)"
    :class="{ 'active sum-active': active }" style="cursor: pointer;">
    {{ item.name }}
