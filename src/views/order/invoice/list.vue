<template>
  <div class="bg-white px-3" style="margin:-20px;margin-top:-1rem;margin-bottom:0 !important">
    ...
    <el-table :data="tableData" style="width: 100%" border class="mt-3" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="order" label="用户名" align="center">
      </el-table-column>
      <el-table-column prop="order" label="开票金额" align="center">
      </el-table-column>
      <el-table-column prop="order" label="抬头" align="center">
      </el-table-column>
      <el-table-column prop="order" label="发票内容" align="center">
      </el-table-column>
      <el-table-column prop="order" label="纳税人识别号" align="center">
      </el-table-column>
      <el-table-column prop="order" label="创建时间" align="center">
      </el-table-column>
