				...
				<template v-else>
					...
					<el-form ref="form" label-width="80px">
						<el-form-item label="添加规格">
							...
							<el-button type="success" size="mini" class="mt-3" @click="addSkuCard">
								添加规格
							</el-button>
						</el-form-item>
					</el-form>
					...
					<el-form ref="form" label-width="80px">
						<el-form-item label="批量设置">
							...
							<div class="d-flex align-items-center" v-else>
								<el-input size="small" style="width:150px;" class="mr-2" type="number" :placeholder="UpdateAllPlaceholder"
					...
					<el-form-item label="商品大图">
						<div class="d-flex flex-wrap">
							<div style="width:150px;height:150px;cursor:pointer;position:relative"
								class="border d-flex align-items-center justify-content-center mr-3 mb-3" v-for="(item, index) in banners"
								:key="index" @click="chooseImage(index)">
								...
								<i class="el-icon-delete p-2 text-white"
									style="position:absolute;top:0;right:0;backgroud-color:rgba(0,0,0.4)"
									@click.stop="deleteImage(index)"></i>
							</div>

							<div v-if="banners.length < 9" style="width:150px;height:150px;cursor:pointer"
								class="border d-flex align-items-center justify-content-center mr-3 mb-3" @click="chooseImage(-1)">
